...
// Display Images With Answer
    function displayImage() {
        if(count === 0) {
            ...
            $("#image-holder").show();
            $("#image-holder").html('<img src="./assets/images/helena_ravenclaw.jpeg">');
        }
        else if(count === 3) {
            $("#image-holder").show();
            $("#image-holder").html('<img src="./assets/images/merope__gaunt.jpg">');
        }
        else if(count === 4) {
            $("#image-holder").show();
            $("#image-holder").html('<img src="./assets/images/snitch.png">');
        }
        else if(count === 5) {
            $("#image-holder").show();
            ...
            $("#image-holder").show();
            $("#image-holder").html('<img src="./assets/images/lion.gif">');
        }
        else if(count === 7) {
            $("#image-holder").show();
